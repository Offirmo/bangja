...
const WHITELIST = [
	...
	'observation:env/npm-version',
	'observation:env/nvm-version',
	'observation:git-repo/current-branch',
	'observation:git-repo/default-branch',
	...
	'diagnostic:env/is-git-version-recent-enough',
	'diagnostic:node/required-version',
	'diagnostic:node/is-required-version-outdated-minor',
	'diagnostic:node/is-required-version-outdated-major',
	'diagnostic:npm-package-declaration/is-engines-section-defined-and-correct',
];
...
function load_module(type, mod_path) {
	try {
		...
		//console.log(`raw module ${id} loaded :\n`, bangja.libs.pretty(raw_mod));
		...
		switch(raw_mod.declaration.interface) {
			...
			case '0.0.1':
				...
				break;
			default:
				throw new Error('unknown interface !', raw_mod.declaration.interface);
				break;
		}
